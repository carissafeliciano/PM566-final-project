...
Instructions on how to access the SEER-17 dataset can be found here.
...
## Figure 1: Distribution of survival time by race/ethnicity
...
p2_bar_survival_race_sex <- ggplot(survival_race_sex) +
  ...
  labs(
      title = "Median Survival Time by Race/Ethnicity and Sex",
      x = "Race/Ethnicity", 
...
p3_bar_survival_race_stage <- ggplot(survival_race_stage) +
  ...
  labs(
    title = "Median Survival Time by Race/Ethnicity and Stage at Diagnosis",
    x = "Race/Ethnicity", 
    y = "Median Survival Time (Months)",
...
## Figure 4: Median survival time by race/ethnicity and histological diagnosis
...
p4_bar_survival_race_hist <- ggplot(survival_race_hist) +
  ...
  labs(
    title = "Median Survival Time by Race/Ethnicity and Histologic Diagnosis",
    x = "Race/Ethnicity", 
    y = "Median Survival Time (Months)",
